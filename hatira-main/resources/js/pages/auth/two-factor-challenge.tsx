    ...
    const authConfigContent = useMemo<{
        ...
        if (showRecoveryInput) {
            return {
                title: 'Kurtarma kodu',
                description:
                    'Hesabınıza erişimi doğrulamak için kurtarma kodlarınızdan birini girin.',
                toggleText: 'doğrulama kodu ile giriş yapabilirsiniz',
            };
        }

        return {
            title: 'Doğrulama kodu',
            description: 'Doğrulama uygulamanızda görünen kodu girin.',
            toggleText: 'kurtarma kodu ile giriş yapabilirsiniz',
        };
    }, [showRecoveryInput]);
