    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'İki adımlı doğrulama artık açık. QR kodunu tarayın veya kurulum anahtarını doğrulama uygulamanıza girin.',
                buttonText: 'Kapat',
            };
        }
        ...
        return {
            ...
            description:
                'Kurulumu bitirmek için QR kodunu tarayın veya kurulum anahtarını doğrulama uygulamanıza girin',
            buttonText: 'Devam et',
        };
